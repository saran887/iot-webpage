...
const statesData = [
  ...
  },
  {
    ...
    districts: [
      ...
      'Muktsar', 'Pathankot', 'Patiala', 'Rupnagar', 'Sangrur', 'SAS Nagar', 'SBS Nagar', 'Sri Muktsar Sahib',
      'Tarn Taran'
    ]
  },
  {
  ...
  },
  {
    ...
    districts: [
      ...
      'Thoothukudi', 'Tiruchirappalli', 'Tirunelveli', 'Tirupathur', 'Tiruppur', 'Tiruvannamalai',
  ...
  },
  {
    ...
    districts: [
      ...
      'Mahabubnagar', 'Mancherial', 'Medak', 'Medchal', 'Mulugu', 'Nagarkurnool', 'Nalgonda', 'Narayanpet',
  ...
  },
  {
    ...
    districts: [
      ...
      'Sant Ravidas Nagar', 'Shahjahanpur', 'Shamli', 'Shrawasti', 'Siddharthnagar', 'Sitapur', 'Sonbhadra',
  ...
  {
    state: 'Lakshadweep',
    districts: ['Agatti', 'Amini', 'Andrott', 'Bithra', 'Chetlat', 'Kadmat', 'Kalpeni', 'Kavaratti', 'Kiltan', 'Minicoy']
  },
  {
    state: 'Puducherry',
